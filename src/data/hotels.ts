...
export const areas: Record<AreaKey, AreaData> = {
  "ayia-napa": {
    ...
    categories: {
      ...
      luxury: [
        {
          name: "Amanti, MadeForTwo Hotels",
          description: "Adults-only luxury retreat designed for couples.",
          tag: "Luxury",
          image: img(0),
          bookingUrl: "https://www.booking.com/hotel/cy/amanti-madefortwo-hotels-ayia-napa.en-gb.html?aid=2311236",
          bestFor: "Romantic getaways",
          location: "Ayia Napa",
          note: "Stylish adults-only hideaway with refined service.",
          category: "luxury",
          stars: 5,
        ...
        {
          name: "Chrysomare Beach Hotel & Resort",
          description: "Spacious 5★ resort with multiple pools and restaurants.",
          tag: "Luxury",
          image: img(3),
          bookingUrl: "https://www.booking.com/hotel/cy/chrysomare-beach.en-gb.html?aid=2311236",
          bestFor: "All-inclusive luxury",
          location: "Ayia Napa",
          note: "Generous grounds and a polished all-inclusive experience.",
          category: "luxury",
          stars: 5,
        },
        {
          name: "Adams Beach Hotel & Spa",
          description: "Iconic beachfront 5★ with a renowned spa.",
          tag: "Luxury",
          image: img(4),
          bookingUrl: "https://www.booking.com/hotel/cy/adams-beach.en-gb.html?aid=2311236",
          bestFor: "Spa and wellness",
          location: "Nissi Beach area",
          note: "Famous spa, calm atmosphere, direct beach access.",
          category: "luxury",
          stars: 5,
        },
        {
        ...
        {
          name: "Mare Ayia Napa",
          description: "Contemporary adults-only 5★ with stylish design.",
          tag: "Luxury",
          image: img(2),
          bookingUrl: "https://www.booking.com/hotel/cy/mare-ayia-napa.en-gb.html?aid=2311236",
          bestFor: "Design-forward couples",
          location: "Ayia Napa",
          note: "Sleek, modern and adults-only — pure relaxation.",
          category: "luxury",
          stars: 5,
        },
      ],

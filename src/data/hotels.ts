  ...
  limassol: {
    ...
    categories: {
      ...
      family: [
        ...
        {
          name: "NYX Hotel Limassol",
          description: "Stylish urban hotel with a vibrant design and rooftop pool.",
          tag: "Family",
          image: img(3),
          bookingUrl: "https://www.booking.com/hotel/cy/nyx-limassol.en-gb.html?aid=2311236",
          bestFor: "Families who like city vibes",
          location: "Central Limassol",
          note: "Modern, fun and walkable to the seafront.",
          category: "family",
          stars: 4,
        },
        {
          name: "Ajax Hotel",
          description: "Long-standing 4★ hotel with spa, pools and spacious rooms.",
          tag: "Family",
          image: img(2),
          bookingUrl: "https://www.booking.com/hotel/cy/ajax.en-gb.html?aid=2311236",
          bestFor: "Families wanting space and value",
          location: "Central Limassol",
          note: "Comfortable rooms and a great indoor pool.",
          category: "family",
          stars: 4,
        },
        {

  ...
  paphos: {
    ...
    categories: {
      ...
      family: [
        ...
        {
          name: "Louis Imperial Beach",
          description: "Beachfront family hotel with great pools and central location.",
          tag: "Family",
          image: img(3),
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Louis+Imperial+Beach+Paphos",
          bestFor: "Beach families",
          location: "Paphos seafront",
          note: "Direct beach access and friendly family service.",
          category: "family",
          stars: 4,
        },
        {

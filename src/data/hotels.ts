...
export const areas: Partial<Record<AreaKey, AreaData>> = {
  ...
  paphos: {
    ...
    categories: {
      ...
      budget: [
        {
          name: "Kefalos Damon Hotel Apartments",
          description: "Affordable apartments with pool and great Paphos location.",
          tag: "Budget",
          image: kefalosDamonImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Kefalos+Damon+Hotel+Apartments+Paphos",
          bestFor: "Budget self-catering",
          location: "Paphos",
          note: "Simple, clean apartments with pool — great value.",
          category: "budget",
          stars: 3,
          highlight: "Best value",
        },
        {
          ...
          description: "Simple central 3★ with pool, walking distance to harbour.",
          tag: "Budget",
          image: dionysosCentralImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Dionysos+Central+Paphos",
          bestFor: "Central budget stays",
          location: "Kato Paphos",
          note: "Friendly, central and very well priced.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Pagona Holiday Apartments",
          description: "Quiet apartments with pool, ideal for relaxed budget trips.",
          tag: "Budget",
          image: pagonaHolidayImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Pagona+Holiday+Apartments+Paphos",
          bestFor: "Relaxed budget stays",
          location: "Kato Paphos",
          note: "Calm setting, kitchenettes and good value.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Pandream Hotel Apartments",
          description: "Family-friendly budget apartments close to the seafront.",
          tag: "Budget",
          image: pandreamImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Pandream+Hotel+Apartments+Paphos",
          bestFor: "Budget seafront stays",
          location: "Kato Paphos seafront",
          note: "Practical apartments close to the sea.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Basilica Holiday Resort",
          description: "Simple 3★ resort with pool, near beach and shops.",
          tag: "Budget",
          image: basilicaHolidayImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Basilica+Holiday+Resort+Paphos",
          bestFor: "Easy budget holidays",
          location: "Kato Paphos",
          note: "Reliable budget option close to the action.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Paphos Gardens Holiday Resort",
          description: "Green, peaceful resort with pools at a low price.",
          tag: "Budget",
          image: paphosGardensImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Paphos+Gardens+Holiday+Resort",
          bestFor: "Quiet budget stays",
          location: "Kato Paphos",
          note: "Spacious gardens, pools and great value.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Tasmaria Aparthotel",
          description: "Affordable aparthotel with pool, popular for value stays.",
          tag: "Budget",
          image: tasmariaImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Tasmaria+Aparthotel+Paphos",
          bestFor: "Self-catering on a budget",
          location: "Kato Paphos",
          note: "Friendly aparthotel with kitchenettes and pool.",
          category: "budget",
          stars: 3,
        },
        {
          name: "Helios Bay Hotel",
          description: "Seafront budget hotel with pools and lovely sunset views.",
          tag: "Budget",
          image: heliosBayImg,
          bookingUrl: "https://www.booking.com/searchresults.en-gb.html?ss=Helios+Bay+Hotel+Paphos",
          bestFor: "Budget seafront stays",
          location: "Chlorakas seafront",
          note: "Great value seafront stay with pools.",
          category: "budget",
          stars: 3,
        },
      ],
